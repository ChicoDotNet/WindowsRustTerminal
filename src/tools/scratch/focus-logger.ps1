# Recovered during dev/migrie branch archaeology from
# dev/migrie/b/13388-focus-logger, commit 211f3160a5884ed34dc173046798f0170bd68e26.
#
# Purpose: identify which process owns the foreground window while investigating
# intermittent focus/activation defects such as microsoft/terminal#13388.
