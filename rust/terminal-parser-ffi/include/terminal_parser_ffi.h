...
terminal_parser_ffi_status terminal_parser_ffi_state_machine_set_csi_lossless_callback(terminal_parser_ffi_state_machine_handle* handle, terminal_parser_ffi_state_machine_csi_lossless_callback callback);
...
terminal_parser_ffi_status terminal_parser_ffi_state_machine_reset_state(terminal_parser_ffi_state_machine_handle* handle);
