...
fn calculate_dimensions(attributes: Attributes, used_width: u16, used_height: u16) -> (u16, u16, u16) {
    ...
    if attributes.declared_width != 0
        && attributes.declared_height != 0
        && !attributes.text_font
    {
    ...
    if attributes.lines_per_page != 24 {
        let cell_width = if attributes.columns_per_page == 132 { 6 } else { 10 };
        let cell_height = if attributes.lines_per_page == 48 { 8 } else { 10 };
...
mod tests {
    ...
    fn microsoft_soft_font_size_detection_matches_every_source_vector() {
        ...
        let bitmap_cases = [
            ...
            (Size80x24, Text, "?????????/?????????/?????????/?????????", (10, 20)),
            (Size80x24, Text, "??????????/??????????/??????????/??????????/??????????", (12, 30)),
            (Size80x24, Text, "????????/????????/????????", (10, 16)),
            (Size132x24, Text, "?????/?????", (6, 10)),
            (Size132x24, Text, "???????/???????", (9, 12)),
            (Size132x24, Text, "?????/?????/?????/?????", (6, 20)),
            (Size132x24, Text, "??????/??????/??????/??????/??????", (7, 30)),
            (Size132x24, Text, "?????/?????/?????", (6, 16)),
            (Size80x24, FullCell, "???????????????/???????????????", (15, 12)),
            (Size80x24, FullCell, "??????????/??????????/??????????/??????????", (10, 20)),
            (Size80x24, FullCell, "????????????/????????????/????????????/????????????/????????????", (12, 30)),
            (Size80x24, FullCell, "??????????/??????????/??????????", (10, 16)),
            (Size132x24, FullCell, "??????/??????", (6, 10)),
            (Size132x24, FullCell, "?????????/?????????", (9, 12)),
            (Size132x24, FullCell, "??????/??????/??????/??????", (6, 20)),
            (Size132x24, FullCell, "???????/???????/???????/???????/???????", (7, 30)),
            (Size132x24, FullCell, "??????/??????/??????", (6, 16)),
        ];
        for (set, usage, data, expected) in bitmap_cases {
            assert_eq!(cell(Default, 0, set, usage, data), Some(expected), "data={data}");
        }
    }
}
